import { d as defineEventHandler, g as getRouterParam, c as createError, D as getShareById, h as getAccounts, F as incrementDownloadCount, x as setHeader } from '../../../../_/nitro.mjs';
import 'crypto';
import 'util';
import 'node:http';
import 'node:https';
...
const downloadAll_get = defineEventHandler(async (event) => {
...
export { downloadAll_get as default };
//# sourceMappingURL=download-all.get.mjs.map
