---
source_url: https://videojs.org/guides/audio-tracks/
scraped_at: 2026-01-09
---

# Documentation Scraped from https://videojs.org/guides/audio-tracks/
...
* Video.js only stores track representations. Switching audio tracks for playback is
  *not handled by Video.js* and must be handled elsewhere - for example,
  [http-streaming](https://github.com/videojs/http-streaming) handles switching
...
This class is based on [the `AudioTrack` standard](https://html.spec.whatwg.org/multipage/embedded-content.html#audiotrack) and can be used to
...
located in the Video.js root and refer to the [languages guide](/guides/languages/) for more
