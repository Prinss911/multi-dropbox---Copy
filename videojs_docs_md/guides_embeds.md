---
source_url: https://videojs.org/guides/embeds/
scraped_at: 2026-01-09
---

# Documentation Scraped from https://videojs.org/guides/embeds/
...
This is an ease-of-use method for having Video.js set up the player automatically. It is an HTML attribute and it takes a JSON string representation of the [player options](/guides/options) as the value.
