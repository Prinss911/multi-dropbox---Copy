---
source_url: https://videojs.org/guides/faqs/
scraped_at: 2026-01-09
---

# Documentation Scraped from https://videojs.org/guides/faqs/
...
* Offers a plugin API so that different types of video can be handed to the native
  video element (e.g. [HLS](https://github.com/videojs/http-streaming), HTML5 video, etc).
...
longer officially supported. Please see [issue #4012](https://github.com/videojs/video.js/issues/4012)
for more information.

## Q: What do Video.js version numbers mean?

Video.js follows [semver](https://semver.org/) which means that the API should not change
out from under a user unless there is a major version increase.

## Q: How can I troubleshoot playback issues?

See the [troubleshooting guide](/guides/troubleshooting). If troubleshooting does not
solve your issue, please ask in [Slack](https://videojs.slack.com) or submit an [issue](/guides/faqs/#q-i-think-i-found-a-bug-with-videojs-or-i-want-to-add-a-feature-what-should-i-do).
...
A pull request would be very welcome in the [Video.js repo](https://github.com/videojs/video.js/pulls).
Make sure to follow the [contributing guide](https://github.com/videojs/video.js/blob/main/CONTRIBUTING.md#contributing-code) and
the [pull request template](https://github.com/videojs/video.js/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
sure that you follow the [issue template](https://github.com/videojs/video.js/blob/main/.github/ISSUE_TEMPLATE.md) and the
[contributing guide](https://github.com/videojs/video.js/blob/main/CONTRIBUTING.md#filing-issues) so that we can better assist you
with your issue.
...
We have a [starter example](https://codepen.io/gkatsev/pen/GwZegv?editors=1000#0) for reduced test cases. To learn more
...
techs/plugins made available to Video.js. For more information on media formats see the [troubleshooting guide](/guides/troubleshooting).
...
see the [autoplay option](/guides/options#autoplay) in the Video.js options guide.
...
[autoplay option](/guides/options#autoplay) with a value of `'any'` or `'muted'`. See the previous link for more information
...
and publish your package to npm. If you use the [plugin generator](https://github.com/videojs/generator-videojs-plugin) this will be done automatically for you. See
the [plugins guide](/guides/plugins) for more information.
...
Alternate video tracks support is in development. See [video tracks guide](/guides/video-tracks)
...
On other browsers, it will play using our playback engine [videojs-http-streaming](https://github.com/videojs/http-streaming).
