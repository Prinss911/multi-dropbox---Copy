---
source_url: https://videojs.org/guides/skins/
scraped_at: 2026-01-09
---

# Documentation Scraped from https://videojs.org/guides/skins/
...
Finally, we can save that as a `videojs-matrix.css` file and include it *after* the Video.js CSS:
